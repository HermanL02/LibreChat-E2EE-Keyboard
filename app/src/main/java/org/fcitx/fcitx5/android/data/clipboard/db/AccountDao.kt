...
interface AccountDao {
    @Insert
    suspend fun insert(account: AccountMessageEntry): Long

    @Query("SELECT * FROM ${AccountMessageEntry.TABLE_NAME}")
    suspend fun getAllAccount(): List<AccountMessageEntry>

    @Query("SELECT * FROM ${AccountMessageEntry.TABLE_NAME} WHERE userId=:userId")
    suspend fun getAccountFromId(userId:String): List<AccountMessageEntry>
